...
/**
 *     Inequality constraints for talc_mp
 *     */
void talc_mp_c(unsigned m, double *result, unsigned n, const double *x, double *grad, void *data){
    result[0] = ( eps_sf + 1.0*x[4]*x[3] - 1.0*x[4] - 1.0*x[3]*x[0] + 1.0*x[3] + 1.0*x[0] - 1.0);
    result[1] = ( eps_sf + -1.0*x[4]*x[3] + 1.0*x[4] + 1.0*x[3]*x[0] - 1.0*x[0]);
    result[2] = ( eps_sf + -1.0*x[3]);
    result[3] = ( eps_sf + -1.0*x[2]*x[0] + 1.0*x[2] - 0.5*x[4]*x[3] + 0.5*x[4] - 1.0*x[0]*x[1] + 1.0*x[0] + 1.0*x[1] - 1.0);
    result[4] = ( eps_sf + 1.0*x[2]*x[0] + 0.5*x[4]*x[3] - 0.5*x[4] + 1.0*x[0]*x[1] - 1.0*x[0]);
    result[5] = ( eps_sf + -1.0*x[2]);
    result[6] = ( eps_sf + -1.0*x[1]);
    result[7] = ( eps_sf + 1.0*x[2] - 1.0*x[3] + 1.0*x[1] - 1.0);
    result[8] = ( eps_sf + -1.0*x[2] + 1.0*x[3] - 1.0*x[1]);

    if (grad) {
        grad[0] = 1.0 - 1.0*x[3];
        grad[1] = 0.0;
        grad[2] = 0.0;
        grad[3] = 1.0*x[4] - 1.0*x[0] + 1.0;
        grad[4] = 1.0*x[3] - 1.0;
        grad[5] = 1.0*x[3] - 1.0;
        grad[6] = 0.0;
        grad[7] = 0.0;
        grad[8] = -1.0*x[4] + 1.0*x[0];
        grad[9] = 1.0 - 1.0*x[3];
        grad[10] = 0.0;
        grad[11] = 0.0;
        grad[12] = 0.0;
        ...
        grad[14] = 0.0;
        grad[15] = -1.0*x[2] - 1.0*x[1] + 1.0;
        grad[16] = 1.0 - 1.0*x[0];
        grad[17] = 1.0 - 1.0*x[0];
        grad[18] = -0.5*x[4];
        grad[19] = 0.5 - 0.5*x[3];
        grad[20] = 1.0*x[2] + 1.0*x[1] - 1.0;
        grad[21] = 1.0*x[0];
        grad[22] = 1.0*x[0];
        grad[23] = 0.5*x[4];
        grad[24] = 0.5*x[3] - 0.5;
...
/**
    Inequality constraints for fluidb
*/
void fluidb_um_c(unsigned m, double *result, unsigned n, const double *x, double *grad, void *data){
    result[0] = ( eps_sf + x[0] - 1.0);
    result[1] = ( eps_sf + -1.0*x[0]);
...
*/
void occm_um_c(unsigned m, double *result, unsigned n, const double *x, double *grad, void *data){
    result[0] = ( eps_sf + x[0] + x[1] - 0.5*x[2] - 1.0);
    result[1] = ( eps_sf + -1.0*x[0] + 0.5*x[2] - 0.25*x[3]);
    result[2] = ( eps_sf + -1.0*x[1] + 0.25*x[3]);
    result[3] = ( eps_sf + x[0] + x[1] + 0.5*x[2] - 1.0);
    result[4] = ( eps_sf + -1.0*x[0] - 0.5*x[2] + 0.75*x[3]);
    result[5] = ( eps_sf + -1.0*x[1] - 0.75*x[3]);
    result[6] = ( eps_sf + x[0] + x[1] + 0.5*x[2] - 1.0);
    result[7] = ( eps_sf + -1.0*x[0] - 0.5*x[2] - 0.25*x[3]);
    result[8] = ( eps_sf + -1.0*x[1] + 0.25*x[3]);
    ...
    if (grad) {
        ...
        grad[4] = -1.00000000000000;
        grad[5] = 0.0;
        grad[6] = 0.500000000000000;
        grad[7] = -0.250000000000000;
        grad[8] = 0.0;
        grad[9] = -1.00000000000000;
        grad[10] = 0.0;
        grad[11] = 0.250000000000000;
        ...
        grad[19] = 0.750000000000000;
        grad[20] = 0.0;
        grad[21] = -1.00000000000000;
        grad[22] = 0.0;
        grad[23] = -0.750000000000000;
        ...
        grad[29] = 0.0;
        grad[30] = -0.500000000000000;
        grad[31] = -0.250000000000000;
        grad[32] = 0.0;
        grad[33] = -1.00000000000000;
        grad[34] = 0.0;
        grad[35] = 0.250000000000000;
    }
...
/**
    Inequality constraints for aphs
*/
void aphs_um_c(unsigned m, double *result, unsigned n, const double *x, double *grad, void *data){
    result[0] = ( eps_sf + x[0] - 1.0);
    result[1] = ( eps_sf + -1.0*x[0]);
...
SS_ref NLopt_opt_mp_talc_function(global_variable gv, SS_ref SS_ref_db){
    ...
    nlopt_set_lower_bounds(SS_ref_db.opt, SS_ref_db.lb);
    nlopt_set_upper_bounds(SS_ref_db.opt, SS_ref_db.ub);
    nlopt_set_min_objective(SS_ref_db.opt, obj_mp_talc, &SS_ref_db);
    nlopt_add_inequality_mconstraint(SS_ref_db.opt, m, talc_mp_c, NULL, SS_ref_db.tol_sf);
    nlopt_set_ftol_rel(SS_ref_db.opt, gv.obj_tol);
    nlopt_set_maxeval(SS_ref_db.opt, gv.maxeval);
    ...
    if (gv.maxeval==1){  
       // we are only interested in evaluating the objective function  
	minf = obj_mp_talc(n, x, NULL, &SS_ref_db);
    }
    else{
    	// do optimization
    	SS_ref_db.status = nlopt_optimize(SS_ref_db.opt, x, &minf);
...
SS_ref NLopt_opt_um_fluidb_function(global_variable gv, SS_ref SS_ref_db){
    ...
    nlopt_set_lower_bounds(SS_ref_db.opt, SS_ref_db.lb);
    nlopt_set_upper_bounds(SS_ref_db.opt, SS_ref_db.ub);
    nlopt_set_min_objective(SS_ref_db.opt, obj_um_fluidb, &SS_ref_db);
    nlopt_add_inequality_mconstraint(SS_ref_db.opt, m, fluidb_um_c, NULL, SS_ref_db.tol_sf);
    nlopt_set_ftol_rel(SS_ref_db.opt, gv.obj_tol);
    nlopt_set_maxeval(SS_ref_db.opt, gv.maxeval);
    ...
    if (gv.maxeval==1){  
       // we are only interested in evaluating the objective function  
       minf = obj_um_fluidb(n, x, NULL, &SS_ref_db);
    }
    else{
      // do optimization
      SS_ref_db.status = nlopt_optimize(SS_ref_db.opt, x, &minf);
...
SS_ref NLopt_opt_um_occm_function(global_variable gv, SS_ref SS_ref_db){
    ...
    nlopt_set_lower_bounds(SS_ref_db.opt, SS_ref_db.lb);
    nlopt_set_upper_bounds(SS_ref_db.opt, SS_ref_db.ub);
    nlopt_set_min_objective(SS_ref_db.opt, obj_um_occm, &SS_ref_db);
    nlopt_add_inequality_mconstraint(SS_ref_db.opt, m, occm_um_c, NULL, SS_ref_db.tol_sf);
    nlopt_set_ftol_rel(SS_ref_db.opt, gv.obj_tol);
    nlopt_set_maxeval(SS_ref_db.opt, gv.maxeval);
    ...
    if (gv.maxeval==1){  
       // we are only interested in evaluating the objective function  
       minf = obj_um_occm(n, x, NULL, &SS_ref_db);
    }
    else{
      // do optimization
      SS_ref_db.status = nlopt_optimize(SS_ref_db.opt, x, &minf);
...
SS_ref NLopt_opt_um_aphs_function(global_variable gv, SS_ref SS_ref_db){
    ...
    nlopt_set_lower_bounds(SS_ref_db.opt, SS_ref_db.lb);
    nlopt_set_upper_bounds(SS_ref_db.opt, SS_ref_db.ub);
    nlopt_set_min_objective(SS_ref_db.opt, obj_um_aphs, &SS_ref_db);
    nlopt_add_inequality_mconstraint(SS_ref_db.opt, m, aphs_um_c, NULL, SS_ref_db.tol_sf);
    nlopt_set_ftol_rel(SS_ref_db.opt, gv.obj_tol);
    nlopt_set_maxeval(SS_ref_db.opt, gv.maxeval);
    ...
    if (gv.maxeval==1){  
       // we are only interested in evaluating the objective function  
       minf = obj_um_aphs(n, x, NULL, &SS_ref_db);
    }
    else{
      // do optimization
      SS_ref_db.status = nlopt_optimize(SS_ref_db.opt, x, &minf);
...
SS_ref NLopt_opt_function(		global_variable   gv,
  ...
  if(gv.EM_database == 0){ 
    ...
    else if (strcmp( gv.SS_list[index], "talc") == 0){
      SS_ref_db  = NLopt_opt_mp_talc_function( gv, SS_ref_db);	}
    else{
    ...
    if 		(strcmp( gv.SS_list[index], "bi") == 0 ){
      ...
      else if (strcmp( gv.SS_list[index], "aphs")  == 0){
         SS_ref_db  = NLopt_opt_um_aphs_function( gv, SS_ref_db);}
      else if (strcmp( gv.SS_list[index], "fluidb")  == 0){
         SS_ref_db  = NLopt_opt_um_fluidb_function( gv, SS_ref_db);}
      else if (strcmp( gv.SS_list[index], "occm")  == 0){
         SS_ref_db  = NLopt_opt_um_occm_function( gv, SS_ref_db);}
      else{
         printf("\nsolid solution '%s index %d' is not in the database\n",gv.SS_list[index], index);
      }
   }
